...
SDcontents:
	@mkdir -p SDcontents
	@mkdir -p SDcontents/System
	@mkdir -p SDcontents/System/Library
	@mkdir -p SDcontents/System/Library/Kernels
	$(MAKE) SDcontents/System/Library/Kernels/kernel

SDcontents/System/Library/Kernels/kernel:
	$(MAKE) -C AchieveOS
